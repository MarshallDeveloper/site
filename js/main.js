...
var main = (function() {
  ...
  Terminal.prototype.type = function(text, callback) {
    if (this.typeSimulator===undefined) {
      if (this.output===undefined) {
        this.output = document.getElementById("output");
      }
      this.typeSimulator = new TypeSimulator(20, this.output);
    }
  ...
  Terminal.prototype.exec = function() {
    ...
    if (this.completePrompt===undefined) {
      this.completePrompt = this.prompt.textContent;
    }
  ...
  Terminal.prototype.prepareSideNav = function() {
    ...
    for (var file in files.getInstance()) {
      ...
      if (this.sidenav===undefined) {
        ...
        if (this.sidenavElements===undefined) {
          this.sidenavElements=[];
    ...
    if (
      ...
      if (lock) {
        document.querySelector(".input").value =
          document.querySelector(".input").value + button.toUpperCase();
      } else {
        document.querySelector(".input").value =
          document.querySelector(".input").value + button;
      }
